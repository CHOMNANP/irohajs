...
var fs = require('fs')
var adminPriv = fs.readFileSync(path.resolve('./users/admin/admin@test.priv')).toString()
var adminPub = fs.readFileSync(path.resolve('./users/admin/admin@test.pub')).toString();

// console.log("adminPub",adminPub)
